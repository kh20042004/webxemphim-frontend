    ...
    const matchesHTML = sportsData.matches.upcoming.slice(0, 10).map(match => `
        <div class="match-card" data-match-id="${match._id}">
            ...
            <div class="match-body">
                <div class="team-vs">
                    <div class="team">
                        <img src="${match.homeTeamLogo || 'https://picsum.photos/seed/team1/60/60'}" alt="Team" onerror="this.src='https://picsum.photos/seed/team1/60/60'">
                        <span class="team-name">${match.homeTeamName || 'Team'}</span>
                    </div>
                    <div class="vs-text">VS</div>
                    <div class="team">
                        <img src="${match.awayTeamLogo || 'https://picsum.photos/seed/team2/60/60'}" alt="Team" onerror="this.src='https://picsum.photos/seed/team2/60/60'">
...
function renderLeagues() {
    ...
    const leaguesHTML = sportsData.leagues.slice(0, 10).map(league => {
        ...
        let leagueLogo = 'https://picsum.photos/seed/' + league.code + '/150/150';
        ...
        <div class="league-card" data-league-id="${league._id}">
            <div class="league-image">
                <img src="${leagueLogo}" alt="${league.name}" onerror="this.src='https://picsum.photos/seed/${league.code}/150/150'">
            </div>
    ...
    const highlightsHTML = highlights.slice(0, 10).map((highlight, idx) => `
        <div class="highlight-card" data-highlight-id="${highlight._id}">
            <div class="highlight-thumbnail">
                <img src="https://picsum.photos/seed/highlight${idx}/300/200" alt="Highlight" onerror="this.src='https://picsum.photos/seed/highlight/300/200'">
            ...
            <div class="match-info">
                <div class="match-teams">
                    <div class="match-team">
                        <div class="team-logo">
                            <img src="${match.homeTeamLogo || 'https://picsum.photos/seed/team1/32/32'}" alt="${match.homeTeamName}" onerror="this.src='https://picsum.photos/seed/team1/32/32'">
                        </div>
                    ...
                    <div class="match-team">
                        <div class="team-logo">
                            <img src="${match.awayTeamLogo || 'https://picsum.photos/seed/team2/32/32'}" alt="${match.awayTeamName}" onerror="this.src='https://picsum.photos/seed/team2/32/32'">
                        </div>
    ...
    const teamsHTML = leagueTeams.slice(0, 20).map(team => `
        <div class="modal-team-card">
            <div class="team-logo-large">
                <img src="${team.logo || 'https://picsum.photos/seed/team/48/48'}" alt="${team.name}" onerror="this.src='https://picsum.photos/seed/team/48/48'">
            </div>
